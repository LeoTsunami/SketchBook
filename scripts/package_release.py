...
def git_release_steps(
    ...
    *,
    ...
    files = [
        ...
        ROOT / "gui" / "icon_utils.py",
        ROOT / "gui" / "main_window.py",
        ROOT / "gui" / "tag_filter_debounce.py",
        ROOT / "gui" / "ressources" / "icones" / "SketchBook.ico",
        ROOT / "scripts" / "build_app_icon.py",
        ...
        ROOT / "tests" / "test_app_icon.py",
        ROOT / "tests" / "test_tag_filter_debounce.py",
