...
TAG_LIBRARY_TAG_GRID_SPACING_PX = 4
TAG_LIBRARY_TAG_CELL_WIDTH_TRIM_PX = 4
...
TAG_LIBRARY_TAG_SHADOW_BLUR_PX = 5
TAG_LIBRARY_TAG_SHADOW_OFFSET_PX = 1
TAG_LIBRARY_TAG_SHADOW_ALPHA = 55
...
TAG_LIBRARY_CHIP_CONTENT_HPAD_PX = 11
