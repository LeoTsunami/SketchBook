...
class UserDataManager:
    ...
    def is_data_dir_locked_by_env(self) -> bool:
        """
        Return True when SKETCHBOOK_DATA_DIR overrides the config file.

        Returns:
            True if the environment variable is set (UI must not change the path).
        """
        return bool(os.getenv("SKETCHBOOK_DATA_DIR"))
